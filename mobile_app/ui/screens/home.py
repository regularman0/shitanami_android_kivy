...
# Version: Kivy_1.3
# Description: Экран ввода. Реализовано сохранение и отправка. (Восстановлено из ошибочного main.py)
...
class HomeScreen(BaseScreen):
    def __init__(self, **kwargs):
        ...
        # Generators
        # Важно передать self.fas_data, даже если она пустая при инициализации
    ...
    def load_config(self):
        if os.path.exists(mobile_schema.FAS_PATH):
            try:
                ...
                # Обновляем конфиг в генераторах
